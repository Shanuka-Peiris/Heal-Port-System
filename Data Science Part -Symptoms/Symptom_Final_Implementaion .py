...
def postData():
    ...
    'neck_pain','dizziness','cramps','obesity','swollen_legs','puffy_face_and_eyes','enlarged_thyroid','brittle_nails','swollen_extremeties',
    'excessive_hunger','drying_and_tingling_lips','slurred_speech','knee_pain','hip_joint_pain','muscle_weakness','stiff_neck',
    ...
    # TRAINING DATA df -------------------------------------------------------------------------------------
    df=pd.read_csv(r"C:\Users\Royal PC\Desktop\Ravija\SDGP\Code\Data Science  - Disease Prediction From Symptoms\Training.csv")
    ...
    # TESTING DATA tr --------------------------------------------------------------------------------
    tr=pd.read_csv(r"C:\Users\Royal PC\Desktop\Ravija\SDGP\Code\Data Science  - Disease Prediction From Symptoms\Testing.csv")
    ...
    # psymptoms = ['itchinig', 'acidity', 'vomiting', 'irritability', 'restlessness' , 'skin_peeling', 'dehydration', 'phlegn', 'back_pain', 'bloody_stool', 'sweating', 'malaise', 'phlegn']
        ...
        for a in range(0,len(disease)):
            if(predicted == a):
                PredictedSymptoms = disease[a]
                addSymptoms.append(PredictedSymptoms)
                for duplicateSymptoms in addSymptoms:
                    if duplicateSymptoms not in realSymptoms:
